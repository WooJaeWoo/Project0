			...
			mc.on("panstart panmove panend", function(event) {
				...
				if (event.type === "panstart") {
                    ...
                    if (left >= 0 && left < this.width - 20) {
                        this.section.find("#tapelineText").removeClass();
						
						if (left < parseInt(this.width / 3)) {
							target.data("value", "A");
							this.section.find("#tapelineText").addClass("lot");
                        } else if ( left > parseInt(this.width * 2 / 3)) {
							target.data("value", "C");
							this.section.find("#tapelineText").addClass("little");
                        } else {
							target.data("value", "B");
							this.section.find("#tapelineText").addClass("soso");
                        }
...
var Answer = {
	...
	submitAnswer: function() {
		if (!this.answerObj.a4) { this.answerObj.a4 = "C"; }
		if (!this.answerObj.a6) { this.answerObj.a6 = "C"; }
